...
| Fase 57 — Las portadas de zona | El slider que Tomy vio en el sitio de Villa del Dique, como portada de cada zona (Buenos Aires · Córdoba · La Costa) en el lugar de la protagonista: `lib/zonas.ts`, `HomeZonas` + `HomeZonasSlider`, `?zona=` como filtro del catálogo, el suelo de la zona como mapa hasta que haya foto aérea. `HomeProtagonist` se va. **562 → 567 tests.** | `1b28293` |
