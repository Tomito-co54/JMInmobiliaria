...
export async function createServiceOrderAction(
  ...
  // Validate the property exists AND is publicly listed. Two-gate filter:
  // source = mine, listing_status = decidí mostrar. Defense in depth — the
  // public detail page already 404s for scraped sources and drafts, but a
