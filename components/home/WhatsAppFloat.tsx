...
import { whatsappLink, GENERIC_LEAD_MESSAGE } from "@/lib/brand/contact";

/**
 * Floating WhatsApp lead button — fixed bottom-right, present across the
...
export function WhatsAppFloat() {
  return (
    <a
      href={whatsappLink(GENERIC_LEAD_MESSAGE)}
      target="_blank"
